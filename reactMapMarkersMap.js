...
// ]
   ...
   function LoadMap() {
       ...
       var mapOptions = {
           center: new window.google.maps.LatLng(window.markers[0].stop_lat, window.markers[0].stop_lon),
           zoom: 8,
       ...
       for (var i = 0; i < window.markers.length; i++) {
           ...
           var myLatlng = new window.google.maps.LatLng(data.stop_lat, data.stop_lon);
